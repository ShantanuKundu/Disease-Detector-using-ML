...
if __name__=='__main__':
    ...
    def button_in():
        ...
        if len(z)==0:
            ...
            diseases=['heart','HEART','Heart','heart disease','HEART DISEASE','Heart Disease','diabetes','diabetes disease','DIABETES','DIABETES DISEASE','Diabetes','Diabetes Disease']
            c=0
            for i in diseases:
                if i==z:
                    c+=1
    ...
    def disease(z):
        global heart_names, diabetes_names
        if z in heart_names:
            hm._in_heart()
